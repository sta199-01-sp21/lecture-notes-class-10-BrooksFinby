...
3/8 = 37.5% for blue, 1/8 = 12.5% for white
...
Extremely close; law of large values
...
I guess that the absolute value of the difference between the two dice rolls has a higher probabilty than the square of dice roll 1 being equal to dice roll 2
